...
Theorem add_inc_count : forall (v:nat) (l:natlist), 
  count v (v :: l) = S (count v l).
Proof.
  intros. 
  assert (Heq: (v =? v) = true).
  { intros. induction v as [| v' IHv'].
    - simpl. reflexivity. 
    - simpl. rewrite -> IHv'. reflexivity.  }
  simpl. rewrite -> Heq. reflexivity. Qed.
...
Proof.
  intros. induction l1 as [| n1 l1' IHl1'].
  - (* l1 = nil *)
...
Proof.
  destruct x. simpl. rewrite -> eqb_refl. reflexivity. Qed.
(** [] *)
